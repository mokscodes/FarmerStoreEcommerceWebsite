        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    ...
                    <p>We have the best products and equipment.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ferta.jpg" alt="ferta">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Fertilizer A</h3>
                                    <p>Price: Rs. 360.00</p>
                                    <p>Description: High in Potaasium</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fertb.jpg" alt="Fertilizer B">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Fertilizer B</h3>
                                    <p>Price: Rs. 400.00</p>
                                    <p>Description: organic fertilizer</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fertc.jpg" alt="Fertilizer C">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Fertilizer C</h3>
                                    <p>Price: Rs. 500.00</p>
                                    <p>Description: Neem Powder, natural fertilizer</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fertd.jpg" alt="Fertilizer D">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Fertilizer D</h3>
                                    <p>Price: Rs. 800.00</p>
                                    <p>Description: Organic Ways Fertilizers </p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
